...
public static class ExceptionExts
{
    ...
    public static IEnumerable<TException> GetInnerExceptions<TException>(this TException ex,
        Func<TException, TException> next = null, Func<TException, bool> @continue = null)
