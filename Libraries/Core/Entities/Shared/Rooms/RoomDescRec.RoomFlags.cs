...
namespace ThePalace.Core.Entities.Shared
{
    public partial class RoomDescRec
    {
        ...
        {
            get => RoomFlags.AuthorLocked.IsBit<RoomFlags, RoomFlags, uint32>(this.RoomInfo.RoomFlags);
        ...
        {
            get => RoomFlags.Private.IsBit<RoomFlags, RoomFlags, uint32>(this.RoomInfo.RoomFlags);
        ...
        {
            get => RoomFlags.NoPainting.IsBit<RoomFlags, RoomFlags, uint32>(this.RoomInfo.RoomFlags);
        ...
        {
            get => RoomFlags.Closed.IsBit<RoomFlags, RoomFlags, uint32>(this.RoomInfo.RoomFlags);
        ...
        {
            get => RoomFlags.CyborgFreeZone.IsBit<RoomFlags, RoomFlags, uint32>(this.RoomInfo.RoomFlags);
        ...
        {
            get => RoomFlags.Hidden.IsBit<RoomFlags, RoomFlags, uint32>(this.RoomInfo.RoomFlags);
        ...
        {
            get => RoomFlags.NoGuests.IsBit<RoomFlags, RoomFlags, uint32>(this.RoomInfo.RoomFlags);
        ...
        {
            get => RoomFlags.WizardsOnly.IsBit<RoomFlags, RoomFlags, uint32>(this.RoomInfo.RoomFlags);
        ...
        {
            get => RoomFlags.DropZone.IsBit<RoomFlags, RoomFlags, uint32>(this.RoomInfo.RoomFlags);
