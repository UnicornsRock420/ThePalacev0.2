namespace ThePalace.Network.Factories
{
    ...
    public class BufferStream : Stream
    {
        ...
        public BufferStream() => _chunks = new();
        ...
        public override long Position
        {
            ...
            get => 0;
            set => throw new NotSupportedException(string.Format("{0} is not seekable", GetType().Name));
        }

        public override bool CanWrite => true;

        public override long Seek(long offset, SeekOrigin origin) =>
            throw new NotSupportedException(string.Format("{0} is not seekable", GetType().Name));
        ...
        public override long Length =>
            (_chunks?.Count ?? 0) < 1 ? 0 : _chunks.Sum(b => b.Length - b.Position);
